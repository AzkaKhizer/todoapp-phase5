    ...
    <AuthProvider>
      <div className="min-h-screen bg-gradient-radial noise relative overflow-hidden flex items-center justify-center p-6">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-gradient-glow rounded-full blur-3xl animate-pulse-slow" />
          <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-gradient-glow rounded-full blur-3xl animate-pulse-slow delay-200" />
        </div>
